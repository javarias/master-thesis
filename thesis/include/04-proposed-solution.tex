...
The solution is modeled after ALMA requirements and current software design detailed in~\cite{avarias11,clarke12,schwarz04,bridger09} and aims to solve the whole ALMA Observation scheduling problem. Although some simplifications are considered, mainly because there are certain requirements that are either still under discussion or they are still unclear. 
