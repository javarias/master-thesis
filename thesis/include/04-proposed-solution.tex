...
\chapter{ALMA Scheduling array problem}
...
\chapter{Array configuration planning problem}
...
\item[Swap two conflicting Array Configurations for given dates] This is the harshest modification for the solution. In fact the SAA proposed will not implement it, since relies completely on the proposed greedy algorithm for this. This modification cannot be applied if there are not conflicting array configurations in the interval desired to modify.
\end{description}
